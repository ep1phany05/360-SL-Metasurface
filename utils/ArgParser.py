...
class Argument:
    ...
    def __init__(self):
        ...
        # Fix code
        self.parser.add_argument('--use_legacy_physics', action='store_true', help='If true, use original (buggy) physics with 1e23 scale')
        self.parser.add_argument('--laser_power', type=float, default=1.0, help='Laser power intensity')
        ...
        self.parser.add_argument('--save_fisheye_path', type=str, default="./11518075/fisheye")
        self.parser.add_argument('--save_pano_path', type=str, default="./11518075/pano")
        ...
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='GPU ids to use, e.g. 0,1,2')
        ...
        self.parser.add_argument('--laser_power_min', type=float, default=1e-1, help='previous def1`ault: 5e-1')
        ...
        self.parser.add_argument('--phase_layer_type', type=str, default='DinerPhaseLayer', help='Parameters/DinerPhaseLayer')
        ...
        input_dir = Path(f"./11518075/")
        self.parser.add_argument('--input_path', type=str, default=input_dir)
        self.parser.add_argument('--train_path', type=str, default=input_dir / "train")
        self.parser.add_argument('--valid_path', type=str, default=input_dir / "test")
        ...
        self.parser.add_argument('--test_path', type=str, default=input_dir / "test")
    ...
    def parse(self):
        ...
        # output_dir = Path(f"./runs/{current_timestamp}/")
        output_dir = Path(f"/data/wudelong/result/360-sl-metasurface/runs/{current_timestamp}/")

        self.parser.add_argument('--output_dir', type=str, default=output_dir)
        self.parser.add_argument('--log', type=str, default=output_dir / "log")
        self.parser.add_argument('--test_save_path', type=str, default=output_dir / "inference")
        self.parser.add_argument('--chk_path', type=str, default=output_dir / "checkpoint")
